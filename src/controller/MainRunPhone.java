...
import services.ManagementAccount;
import services.ManagementBill;
import services.ManagementPhone;
import readwritefile.ReadWriteCsv;
import services.ValidatePhone;
            ...
            switch (choice){
                case 1:
                    ...
                    if (managementPhone.checkExistedId(id)){
                        ...
                        do {
                            ...
                            if (!validatePhone.valid(capacity,validatePhone.getCapacityRegex())){
                                System.out.println("sai định dạng nhập lại đi!");
                            }
                        }while (!validatePhone.valid(capacity,validatePhone.getCapacityRegex()));
                        ...
                        do {
                            ...
                            if (!validatePhone.valid(nsx,validatePhone.getNsxRegex())){
                                System.out.println("sai định dạng nhập lại đi!");
                            }
                        }while (!validatePhone.valid(nsx,validatePhone.getNsxRegex()));
                ...
                case 3:
                    ...
                    if (managementPhone.findById(idPhone) == -1){
                        ...
                        do {
                            ...
                            if (!validatePhone.valid(capacity1,validatePhone.getCapacityRegex())){
                                System.out.println("sai định dạng nhập lại đi!");
                            }
                        }while (!validatePhone.valid(capacity1,validatePhone.getCapacityRegex()));
                        ...
                        do {
                            ...
                            if (!validatePhone.valid(nsx1,validatePhone.getNsxRegex())){
                                System.out.println("sai định dạng nhập lại đi!");
                            }
                        }while (!validatePhone.valid(nsx1,validatePhone.getNsxRegex()));
                ...
                case 8:
                    ...
                    do {
                        ...
                        if (!validatePhone.valid(phoneNumber,validatePhone.getPhonenumberRegex())){
                            System.out.println("sai định dạng nhập lại đi!");
                        }
                    }while (!validatePhone.valid(phoneNumber,validatePhone.getPhonenumberRegex()));
                    ...
                    do {
                        ...
                        if (!validatePhone.valid(dayOrDer,validatePhone.getDayorderRegex())){
                            System.out.println("sai định dạng nhập lại đi!");
                        }
                    }while (!validatePhone.valid(dayOrDer,validatePhone.getDayorderRegex()));
